    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="w-full h-full flex flex-col items-center justify-center">
        <h1 className="text-2xl font-semibold mt-1 mb-8">
          Welcome to Natural Action Agent Vessel
        </h1>
        ...
        <div className="flex gap-6">
          <Card className="w-[400px] py-5">
            <CardHeader className="px-5">
              ...
              <CardDescription>
                Use Noshi's AI model to automate and complete tasks directly on
          ...
          <Card className="w-[400px] py-5">
            <CardHeader className="px-5">
              ...
              <CardDescription>
                Let Noshi's AI model help you automate browser tasks, from
